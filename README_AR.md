...
- **تصنيف المواقع**: تنظيم كلمات المرور حسب المواقع
- **ملاحظات إضافية**: إضافة ملاحظات لكل كلمة مرور (v1.0+)

### 🎨 واجهة المستخدم
- **تصميم عربي**: واجهة مستخدم مصممة خصيصاً للمستخدمين العرب
...
### خطوات التثبيت
1. قم بتحميل أحدث إصدار من [صفحة الإصدارات](https://github.com/yourusername/SafeLogin/releases)
...
1. **الإبلاغ عن الأخطاء**: استخدموا [صفحة المشاكل](https://github.com/yourusername/SafeLogin/issues)
